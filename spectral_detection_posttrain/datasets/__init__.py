...
def build_detection_loaders(
    ...
    if dataset in {"coco", "coco2017", "coco_2017"}:
        from .coco_detection import build_coco_detection_loaders

        return build_coco_detection_loaders(config, limit_train, limit_val, batch_size)
