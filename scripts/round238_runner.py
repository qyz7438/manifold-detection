"""Plan 2.38: SPR (Stochastic Proposal Refiner) — Plan A implementation.

RPN freeze → base proposals → SPR Head (μ,σ) → sample M refined boxes per proposal
→ each candidate gets independent ROI Align → FFT reward vs GT → REINFORCE.
"""
...
def main():
    ...
    for alpha in ALPHAS:
        run_name = f"round238_spr_a{alpha}_s42"
        set_seed(42)
