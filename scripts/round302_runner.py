"""Plan 3.2: Aggressive RLVR — test NMS bottleneck hypothesis.
...
def run_one(cfg_name, mode, seed):
    run_name = f"round302_{cfg_name}_s{seed}"
    set_seed(seed)
    model = bm().to(DEV)
...
if __name__ == "__main__":
    ...
    print("\n## Plan 3.2 RLVR on Classifier — IoU-Calibrated Confidence Reward")
