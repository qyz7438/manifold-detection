"""Plan 2.66: FFT-only verifier with 28×28 ROI Align — maximum frequency resolution."""
...
DEV="cuda";CKPT="runs/round227_v1_baseline_20ep/checkpoint_best.pth";G=4;EPOCHS=5;ROI_SIZE=28
...
def main():
    all_r=[]
    for lbd in [0.1,0.5]:
        run_name=f"round266_fft28_l{lbd}_s42";set_seed(42)
    ...
    print("\n## Plan 2.66 v6 FFT-Only 28x28 Results")
